...
def run_PTI(c, image_name, run_name='', use_wandb=False, use_multi_id_training=False, evaluation=False, trunc=1.0):
    ...
    if use_multi_id_training:
        ...
        coach = SingleIDCoach(c, image_name, dataloader, use_wandb, evaluation=evaluation, trunc=trunc)
